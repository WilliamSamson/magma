...
pub(super) fn build_about_page() -> GtkBox {
    ...
    page.add_css_class("magma-settings-about-page");
    ...
    panel.add_css_class("magma-settings-about-panel");
    ...
    let title = about_label("magma", "magma-settings-about-title");
    let name = about_label("X.R.1.9 - Kayode", "magma-settings-about-name");
    let meta = about_label(APP_VERSION, "magma-settings-about-meta");
    ...
    credits_box.add_css_class("magma-about-credits-box");

    let engine_box = GtkBox::new(Orientation::Vertical, 2);
    let engine_label = about_label("Engine", "magma-about-category-label");
    ...
    let design_label = about_label("Design & Development", "magma-about-category-label");
    ...
    license_label.add_css_class("magma-about-license-text");
...
fn section_header(text: &str) -> Label {
    ...
    label.add_css_class("magma-about-section-header");
...
fn linked_label(text: &str, url: &str) -> Label {
    ...
    label.add_css_class("magma-about-link");
    label.set_xalign(0.5);
    label
}
