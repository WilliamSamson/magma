...
impl LogsFeature {
    ...
    fn build_lines(&self, shell: ShellContext) -> Vec<Line<'static>> {
        ...
        let visible = filtered
            ...
            .take(self.view.viewport_height);
        ...
        lines.push(Line::from(layout::status_line(
            self.ui.last_action.as_deref(),
        )));
    ...
    fn handle_key(&mut self, key: KeyEvent) {
        ...
        match key.code {
            ...
            KeyCode::PageUp => {
                self.view.scroll = self.view.scroll.saturating_sub(self.view.viewport_height)
            }
